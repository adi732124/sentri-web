  ...
  return (
    <>
      <section id="center">
        ...
        <div>
          <h1>Sentri</h1>
          <p>Real-Time Developer Monitoring &amp; Collaboration Platform</p>
        </div>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link to="/dashboard">
            <Button variant="secondary" size="md">Open Dashboard →</Button>
          </Link>
        </div>
      </section>
      ...
      <section id="next-steps" style={{ flexDirection: 'column', gap: 40, padding: '32px 24px' }}>
        ...
        <Card title="Avatar" description="5 sizes · initials fallback · 4 status indicators">
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <Avatar name="John D" size="lg" status="busy" />
            <Avatar name="Sara M" size="md" status="away" />
        ...
        <Card title="Card" description="Composable container with header, body, and footer">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 16 }}>
            <Card title="Bordered" description="Default style" bordered>Body content here.</Card>
            <Card title="Shadow" description="Elevated" shadow bordered={false}>Body content here.</Card>
            <Card
              title="With footer"
              description="Actions in footer"
              footer={
